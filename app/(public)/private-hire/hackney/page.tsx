...
export default function HackneyPrivateHireRedirect() {
  ...
  useEffect(() => {
    window.location.replace(`${basePath}/private-hire`);
  }, [basePath]);

  return (
    <main className="flex min-h-[60vh] flex-col items-center justify-center px-6 py-20 text-center">
      <meta httpEquiv="refresh" content={`0; url=${basePath}/private-hire`} />
      <h1 className="font-display text-3xl uppercase tracking-wider">
        This page has moved
      </h1>
      <p className="mt-3 text-sm text-cream/70">
        Private hire now lives at /private-hire. Taking you there…
      </p>
      <Link
        href="/private-hire"
