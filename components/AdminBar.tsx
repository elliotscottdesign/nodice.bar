...
function pathToAdminContent(pathname: string): {
  ...
  const map: Array<[RegExp, string, string]> = [
    ...
    [/^\/privatehire\/hackney/, "/admin/content/privatehire/hackney", "Private hire — Hackney"],
    [/^\/privatehire\/borough-market/, "/admin/content/privatehire/borough", "Private hire — Borough"],
    [/^\/privatehire/, "/admin/content/privatehire", "Private hire"],
    [/^\/about/, "/admin/content/info/about", "About"],
    [/^\/contact/, "/admin/content/info/contact", "Contact"],
    [/^\/faqs/, "/admin/content/info/faqs", "FAQs"],
    [/^\/snackbar/, "/admin/content/info/snackbar", "Snack Bar"],
